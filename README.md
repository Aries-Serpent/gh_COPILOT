...
Run `python -m scripts.compliance_score_cli` to print the most recent composite score stored in `analytics.db` as JSON. Use `--db` to specify an explicit database path if needed.
