...
The `UnifiedWrapUpOrchestrator` automatically triggers a minimal WLC session at
the end of its workflow to capture compliance metrics in the same database.
