...
class MockValidator(BaseValidator):
    ...
    def validate(self, target) -> ValidationResult:
        if self.should_pass:
            return ValidationResult(status=ValidationStatus.PASSED, message=f"{self.name} passed")
        else:
            return ValidationResult(
                status=ValidationStatus.FAILED, message=f"{self.name} failed", errors=["Mock validation error"]
            )
...
class TestValidationCore:
    ...
    def test_validation_result_creation(self):
        ...
        result = ValidationResult(status=ValidationStatus.PASSED, message="Test passed")
    ...
    def test_validation_result_failure(self):
        ...
        result = ValidationResult(status=ValidationStatus.FAILED, message="Test failed", errors=["Error 1", "Error 2"])
...
class TestValidationRules:
    ...
    def test_rule_based_validator(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            rules = [FileExistsRule(str(test_file)), NoZeroByteFilesRule(temp_path)]
...
class TestDeploymentValidator:
    ...
    def test_validate_enterprise_certificate_valid(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            certificate_data = {"ENTERPRISE_READINESS": {"overall_readiness_percentage": 100.0}}
...
class TestValidationReporting:
    ...
    def test_json_report_format(self):
        ...
        results = [ValidationResult(ValidationStatus.PASSED, "Test passed")]
