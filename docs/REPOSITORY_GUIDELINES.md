...
The primary guidelines are in `AGENTS.md` at the repository root (also under `.github/instructions/AGENTS.md`). Any older guides are archived under `_MANUAL_DELETE_FOLDER/`.
