        ...
        try:
            with sqlite3.connect(self.database_path) as conn:
                ...
                for row in cursor.fetchall():
                    ...
                    moderate_success_count = len([code for code in codes if code in self.moderate_success_violation_types])
...
def main():
    ...
    try:
        ...
        if results_phase1['overall_success_rate'] >= 0.75:
            ...
            total_processed = results_phase1['total_violations_processed'] + results_phase2['total_violations_processed']
