            ...
            for i, file1 in enumerate(files):
                for file2 in files[i+1:]:
                    similarity = self.calculate_semantic_similarity(
                        semantic_patterns[file1], 
                        semantic_patterns[file2]
                    )
