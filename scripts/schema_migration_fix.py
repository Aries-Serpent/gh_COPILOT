...
class VisualProcessingIndicators:
    ...
    def show_completion_summary(migration_count: int):
        ...
        print(
            f"[TIME] Completion Time: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if 'intelligence_type' not in column_names:
                    ...
                    self.logger.info(
                        "Successfully added intelligence_type column")
                ...
                if 'intelligence_data' not in column_names:
                    ...
                    self.logger.info(
                        "Successfully added intelligence_data column")
                ...
                if 'source_analysis' not in column_names:
                    ...
                    self.logger.info(
                        "Successfully added source_analysis column")
