...
class ComprehensiveScriptValidator:
                    ...
                    (
                        ...
                        len(
                            [
                                ...
                                if r.overall_status in [ValidationSeverity.CRITICAL, ValidationSeverity.ERROR]
                            ]
                        ),
    ...
    def generate_validation_report(self) -> Dict[str, Any]:
        ...
        self.critical_issues_count = sum(
            len([i for i in r.issues if i.severity == ValidationSeverity.CRITICAL]) for r in self.validation_results
        )
