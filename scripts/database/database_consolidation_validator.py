...
class DatabaseConsolidationValidator:
    ...
    def count_and_measure_databases(self) -> Dict:
        ...
        for db_file in db_files:
            ...
            db_info.append({"name": db_file.name, "size_mb": round(size_mb, 2)})
        ...
        return {"count": len(db_files), "total_size_mb": round(total_size, 2), "databases": db_info}
            ...
            try:
                ...
                with sqlite3.connect(str(db_file)) as conn:
                    ...
                    if result and result[0] == "ok":
                        ...
                        integrity_results["failed_databases"].append({"name": db_file.name, "error": str(result)})

                integrity_results["total_checked"] += 1

            except Exception as e:
                integrity_results["failed"] += 1
                integrity_results["failed_databases"].append({"name": db_file.name, "error": str(e)})
    ...
    def run_comprehensive_validation(self) -> Dict:
        ...
        if (
            integrity["failed"] == 0
            and functionality["tests_failed"] == 0
            and autonomous["system_health"] in ["HEALTHY", "WARNING"]
            and compliance["consolidation_effectiveness"]["target_met"]
        ):
