...
def cleanup_orphaned_config_files() -> Dict[str, Any]:
...
def validate_config_directory() -> bool:
    ...
    config_files = (
        list(config_dir.rglob("*.json"))
        + list(config_dir.rglob("*.yml"))
        + list(config_dir.rglob("*.yaml"))
        + list(config_dir.rglob("*.cfg"))
        + list(config_dir.rglob("*.ini"))
        + list(config_dir.rglob("*.conf"))
    )
