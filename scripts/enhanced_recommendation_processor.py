...
def process_recommendations():
    ...
    config_files = ["pyproject.toml", "docker-compose.yml", "Dockerfile", "Makefile"]
    ...
    temp_patterns = ["__pycache__/**/*.pyc", "*.tmp", "*.log.old", ".pytest_cache/**/*"]
    ...
    critical_dirs = ["logs", "reports", "validation", "monitoring", "security"]
