...
format = '%(asctime)s - %(levelname)s - %(message)s'
    ...
    def fix_existing_json_files(self):
        ...
        for env_name, env_path in environments:
                ...
                try:
                    ...
                    try:
                        ...
                        if needs_fix:
                            ...
                            env_fixed += 1
                            self.logger.info(
                                f"Fixed datetime serialization in {json_file.name}")
                        ...
                        try:
                            ...
                            if fixed_content:
                                ...
                                self.logger.info(
                                    f"Repaired malformed JSON in {json_file.name}")
            ...
            print(
                f"  {env_name.upper()} - Files processed: {env_processed}, Fixed: {env_fixed}")
